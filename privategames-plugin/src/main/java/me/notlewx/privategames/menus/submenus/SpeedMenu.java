...
public class SpeedMenu implements GUIHolder {
    ...
    public void addContents() {
        ItemStack arrow = new ItemStack(Material.getMaterial(mainConfig.getString(SPEED_BACK_MATERIAL )));
        ItemMeta arrowMeta = arrow.getItemMeta();
        ItemStack book1 = new ItemStack(Material.getMaterial(mainConfig.getString(SPEED_LEVEL_I_MATERIAL)));
        ItemMeta book1Meta = book1.getItemMeta();
        ItemStack book2 = new ItemStack(Material.getMaterial(mainConfig.getString(SPEED_LEVEL_II_MATERIAL)));
        ItemMeta book2Meta = book2.getItemMeta();
        ItemStack book3 = new ItemStack(Material.getMaterial(mainConfig.getString(SPEED_LEVEL_III_MATERIAL)));
        ItemMeta book3Meta = book3.getItemMeta();
        ItemStack book4 = new ItemStack(Material.getMaterial(mainConfig.getString(SPEED_LEVEL_IV_MATERIAL)));
