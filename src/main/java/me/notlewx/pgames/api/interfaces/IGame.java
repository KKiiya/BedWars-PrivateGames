...
public interface IGame {
     ...
     * @return boolean
     */
    boolean isArenaPrivate(String arena);
     ...
     * GUI.
     */
    void setArenaPrivate(String arenaName, boolean value);

    /**
     * Set the owner of the private arena
     *
     */
    void setPrivateArenaOwner(String arenaName, Player player);
     ...
     */
    Player getOwnerOfPrivateArena(String arenaName);
     ...
     * @return boolean
     */
    boolean isOwnerOfArena(Player player, String arenaName);
    /**
     * Get the actual arenas that are in
     * a private state
     * @return list of arenas
     */
    List<String> getPrivateGames();
}
